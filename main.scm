...
;; for this implementation, we will need to define a divider

(define (divider d1 d2 quotient)
  (define (process-new-value)
    (cond ((and (has-value? d2) (= (get-value d2) 0))
           (error "division by zero -- DIVIDER" (get-value d2)))
          ((and (has-value? d1) (= (get-value d1) 0) (has-value? d2) (not (= (get-value d2) 0)))
          ...
          ((and (has-value? quotient) (has-value? d1))
           (set-value! d2
                       (* (get-value quotient) (get-value d1))
                       me))
          ((and (has-value? quotient) (has-value? d2))
           (set-value! d1
                       (* (get-value quotient) (get-value d2))
                       me))))
  (define (process-forget-value)
